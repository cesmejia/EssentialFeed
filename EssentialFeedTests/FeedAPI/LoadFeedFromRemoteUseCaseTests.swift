...
final class LoadFeedFromRemoteUseCaseTests: XCTestCase {
    ...
    private func makeItem(id: UUID = .init(), decription: String? = nil, location: String? = nil, imageURL: URL = URL(string: "https://a-url.com")!) -> (model: FeedImage, json: [String: Any]) {
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWith expectedResult: EssentialFeed.LoadFeedResult, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
